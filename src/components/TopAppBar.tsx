      ...
      <div className="flex items-center justify-between px-6 h-16 w-full max-w-md mx-auto">
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          <div className="overflow-hidden">
            <h1 className="text-xl font-bold tracking-tighter text-[#1A2B3C] dark:text-white uppercase truncate">{title}</h1>
            {subtitle && (
              <p className="text-[10px] font-medium text-slate-500 uppercase tracking-widest flex items-center gap-1 truncate">
                {subtitle}
              </p>
            )}
          </div>
